# NO BORRAR — cascaron pre-montado de `board-aurum`

Este repo existe para que, el dia de la mudanza, la liga vieja
`https://alexpueblag.github.io/board-aurum/` no muera ni un minuto.

Ese dia se renombra a `board-aurum` y toma su lugar **ya construido**.
...
retirado el nombre `board-aurum` por trafico, en cuyo caso esa direccion
